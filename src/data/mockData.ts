...
export const mockRider: Rider = {
  ...
  rating: 4.8,
  vehicle: 'Bajaj Boxer 150 (Motorbike)',
  avatar:
...
export const mockOrders: Order[] = [
{
  ...
  pickup: { address: 'Westlands, Nairobi' },
  dropoff: { address: 'Kilimani, Nairobi' },
...
},
{
  ...
  pickup: { address: 'Sarit Centre, Nairobi' },
  dropoff: { address: 'Upper Hill, Nairobi' },
